                ...
                if(myHandler == null){
                   ...
                   Object result = myHandler.getMethod().invoke(myHandler.getController());
                    ...
                    if(result instanceof String){
                        ...
                        if(method.isAnnotationPresent(YphResponseBody.class)){
                            //将返回值转换成 json格式数据
        ...
        for (Map.Entry<String, Object> entry : webApplicationContext.iocMap.entrySet()) {
            ...
            if(clazz.isAnnotationPresent(YphController.class)){
                ...
                for (Method method : methods) {
                    ...
                    if(method.isAnnotationPresent(YphRequestMapping.class)){
                        YphRequestMapping requestMapping = method.getAnnotation(YphRequestMapping.class);
                        //获取注解中的值   /findUser
